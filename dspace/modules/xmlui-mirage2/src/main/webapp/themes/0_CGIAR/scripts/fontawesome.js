...
import { faRss, faAt, faEnvelope, faChartBar, faTable, faSquare, faSortDown } from '@fortawesome/free-solid-svg-icons'
...
library.add(faRss, faAt, faEnvelope, faChartBar, faTable, faSquare, faSortDown)
